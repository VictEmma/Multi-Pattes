      ...
      <section class="about">
          <div class="title">
            ...
            <div class="img-txt">
                ...
                <div class="reseaux">
                    <a href="https://www.facebook.com/p/Multi-pattes-100085392571223/"><img src="<?php echo get_template_directory_uri(); ?>/img/fb-logo.png" alt="Réseaux sociaux" width="100" height="100"></a>
                    <a href="https://www.instagram.com/multipattes38/"><img src="<?php echo get_template_directory_uri(); ?>/img/ig-color.png" alt="Réseaux sociaux" width="100" height="100"></a>
                    <a href="lien.com"><img src="<?php echo get_template_directory_uri(); ?>/img/tiktok-color.png" alt="Réseaux sociaux" width="100" height="100"></a>
                </div>
                </div>
                <div class="title2">
                    <h2 class="custom-title">Documents</h2>
                    <a href="document.pdf"><img src="<?php echo get_template_directory_uri(); ?>/img/file.png" alt="Réseaux sociaux" width="60" height="60" class="img-docs"></a>
                    <a href="document.pdf"><img src="<?php echo get_template_directory_uri(); ?>/img/file.png" alt="Réseaux sociaux" width="60" height="60" class="img-docs"></a>
                </div>
            </div>
      </section>
